...
{
    public class PSCSubDialog : PSCPageBase, IDataContainer
    {
        private static string NameSessionShare = "PSCSubDialogNameSessionShare";
        ...
        private static string NameSession = "PSCSubDialog";
