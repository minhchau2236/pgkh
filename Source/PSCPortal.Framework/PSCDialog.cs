...
{
    public class PSCDialog : PSCPageBase, IDataContainer
    {
        private static string NameSessionShare = "PSCDialogNameSessionShare";
        ...
        private static string NameSession = "PSCDialog";
