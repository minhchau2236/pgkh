<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="PSCPortal.Modules.AlbumOrtherPages.Display" %>
...
<div class="title_topic_show" style="padding-top: 10px;">
    <div class="text_title_show">
        <img src="/Resources/ImagePhoto/icon_title.png" /><asp:HyperLink ID="hplArrivalTypeName"
            CssClass="hplClass" runat="server" Font-Underline="false"></asp:HyperLink></div>
    <div class="line_topic_show">
        <img src="/Resources/ImagePhoto/arrow_title.png" /></div>
</div>
<asp:Panel ID="pnDisplayAlbum" runat="server">
    <div class="content_show" id="Conten" runat="server" style="width: 600px">
        <div class="imgl_album">
            <img src="/Resources/ImagePhoto/top_showimg.jpg" width="585px" /></div>
                    ...
                    <div class="td_album">
                        <div class="hinhalbum">
                            <img style="cursor: hand" src="<%#Eval("PathImgFirst") %>"
                                alt="" onclick="chuyentrang('<%#Eval("Path") %>')" /></div>
        ...
        <div class="imgl_album">
            <img src="/Resources/ImagePhoto/bottom_img.jpg" width="585px" /></div>
    </div>
            ...
            <div class="td_sp">
                <div class="hinhsp">
                    <a href="<%#Eval("Path") %>" rel="lightbox1" class="effectable">
                        <img border="0" style="cursor: pointer" src="<%# Eval("Path") %>" alt="sample 1" title="sample 1" /></a>
                </div>
                <div class="title_sp">
                    <%--<a href="#"><%#Eval("Name")%></a>--%>
                </div>
...
<script language="javascript" type="text/javascript">
    function chuyentrang(Path) {
        window.location.href = "?ModuleId=7dbf64b8-7889-4c2d-9433-2801f48ce509&Path=" + Path; //  +"&Link=" + $(".hplClass").text();
    }
</script>
