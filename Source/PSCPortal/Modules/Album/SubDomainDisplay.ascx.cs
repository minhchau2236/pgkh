...
{
    public partial class SubDomainDisplay : System.Web.UI.UserControl
    {
        ...
        public string Root
        {
            get
            {
                return SubDomainName != string.Empty
                   ? string.Format("/Resources/Albums/SubDomain/{0}", SubDomainName)
                   : "/Resources/Albums/SubDomain/HomePage";
            }
        }
