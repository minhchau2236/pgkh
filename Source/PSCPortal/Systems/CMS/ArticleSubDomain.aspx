<%@ Page EnableViewState="false" Title=""
    Language="C#" MasterPageFile="~/Systems/DialogMasterPage.Master" AutoEventWireup="true"
    CodeBehind="ArticleSubDomain.aspx.cs" Inherits="PSCPortal.Systems.CMS.ArticleSubDomain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetSubDomainList() {
            var tableView = $find("<%=gvSubDomain.ClientID%>").get_masterTableView();
