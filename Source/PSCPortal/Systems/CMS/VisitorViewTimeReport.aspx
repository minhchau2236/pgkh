<%@ Page Title="" Language="C#" MasterPageFile="~/Systems/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="VisitorViewTimeReport.aspx.cs" Inherits="PSCPortal.Systems.CMS.VisitorViewTimeReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function gvThongke_Command(sender, args) {
            ...
            PageMethods.VisitorLoadCommand(currentPageIndex * pageSize, pageSize, sortExpressions.toString(), VisitorLoadCommandCallback);
        }
        function VisitorLoadCommandCallback(results) {                        
           ShowGrid();
        ...
        function Search() {            
            ...
            PageMethods.Search(tungay, denngay, 0, tableView.get_pageSize(), sortExpressions.toString(), VisitorLoadCommandCallback);
        }
        //button Xuất Excel
        function XuatExcel() {            
            var tungay = rdtpTuNgay.get_dateInput().get_value();
            var denngay = rdtpDenNgay.get_dateInput().get_value();
            window.open("/Services/ExportToExcel.ashx?fromDate=" + tungay + "&toDate=" + denngay + "&option=TKTruyCapTrang");
        }       
    </script>
</asp:Content>
    ...
    <div style="clear: both; float: left; width: 700px; padding: 0px 10px 10px 10px;">
        <div style="clear: both; float: left; padding: 0px 0px 0px 130px">
            <fieldset style="border-right: #006699 1px solid; border-top: #006699 1px solid;
                ...
                <div style="clear: both; float: left; padding: 0px 0px 0px 150px; height: 30px; font-weight: bold;">
                    Thống kê số lượng truy cập trang</div>
        ...
        <div style="clear: both; float: left; padding: 10px 0px 0px 0px">
            <telerik:RadGrid ID="gvThongke" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                AllowSorting="True" GridLines="None" AllowMultiRowSelection="True" Height="300px"
                Width="800px">
                <MasterTableView ClientDataKeyNames="Id" AllowMultiColumnSorting="True">
                    <Columns>
                        <telerik:GridBoundColumn HeaderText='Sub Domain' DataField="Title">
