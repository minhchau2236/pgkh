<%@ Page Title="" Language="C#" MasterPageFile="~/Systems/MasterPage.Master" AutoEventWireup="true" CodeBehind="ArticleViewTimeReport.aspx.cs" Inherits="PSCPortal.Systems.CMS.ArticleViewTimeReport" %>
    ...
    <script type="text/javascript" language="javascript">
       ...
       //button Tìm
        ...
        function XuatExcel() {
            var tungay = rdtpTuNgay.get_dateInput().get_value();
            var denngay = rdtpDenNgay.get_dateInput().get_value();
            window.open("/Services/ExportToExcel.ashx?fromDate=" + tungay + "&toDate=" + denngay + "&option=TKTruyCapBaiViet");
        }
 </script>
</asp:Content>
        ...
        <div style="clear: both; float: left; padding: 0px 0px 0px 130px">
            <fieldset style="border-right: #006699 1px solid; border-top: #006699 1px solid;
                ...
                <div style="clear: both; float: left; padding: 0px 0px 0px 150px; height: 30px;
                    font-weight: bold;">
                    Thống kê số lượng truy cập bài viết</div>
