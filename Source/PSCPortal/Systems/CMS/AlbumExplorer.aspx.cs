...
{
    public partial class AlbumExplorer : PSCPortal.Framework.PSCPage
    {
        ...
        protected void LoadCustomEditor()
        {
            ...
            if (!subId.Equals(Guid.Empty.ToString()))
            {
                ...
                Libs.Ultility.SettingFileExplorer(RadFileExplorer1, "~/Resources/Albums/SubDomain/", subdomain.Name);
            }
            else
            {
