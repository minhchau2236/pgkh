<%@ Page Title="" Language="C#" MasterPageFile="~/Systems/DialogMasterPage.Master" AutoEventWireup="true" CodeBehind="ArticleLoginDetail.aspx.cs" Inherits="PSCPortal.Systems.CMS.ArticleLoginDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-left: 15px; font-family: Arial, Helvetica, sans-serif; font-weight: bold;
        margin-bottom: 15px">
        Chú ý:
        <span style="font-weight:normal; font-size:11px">Chức năng "Cập nhật đăng nhập" quản lý "Tên, Mật khẩu" của một bài viết. Khi người dùng muốn
       xem bài viết thì phải đăng nhập đúng "Tên, Mật khẩu" này.
        </span>
    </div>    
