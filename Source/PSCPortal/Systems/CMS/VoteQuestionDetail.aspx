<%@ Page Language="C#" MasterPageFile="~/Systems/DialogMasterPage.Master" AutoEventWireup="true" CodeBehind="VoteQuestionDetail.aspx.cs" Inherits="PSCPortal.Systems.CMS.VoteQuestionDetail" Title="Untitled Page" %>
...
<script language="javascript" type="text/javascript">
        ...
        function Save() {
            var cbIsCheck = document.getElementById("<%=cbIsCheck.ClientID%>");
            var txtName = document.getElementById("<%= txtName.ClientID %>");
            if (txtName.value == "")
                radalert("Bạn vui lòng nhập vào tên của câu hỏi !!", 250, 100, "Chú ý");
            else
                 PageMethods.Save(txtName.value, cbIsCheck.checked, CallWebMethodSuccess, CallWebMethodFailed);
        }       
