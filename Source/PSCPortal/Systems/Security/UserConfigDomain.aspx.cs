...
{
    public partial class UserConfigDomain : PSCPortal.Framework.PSCDialog
    {
        ...
        protected static SubDomainCollection BeforeSubDomainList
        {
            get
            {
                ...
                {
                    DataStatic["BeforeSubDomainList"] = SubDomainCollection.GetSubDomainByUser(Args.User);
                }
        ...
        protected static SubDomainCollection DisplaySubDomainList
        {
            get
            {
                ...
                {
                    foreach (var item in BeforeSubDomainList.Where(a=>a.Id != Guid.Empty).ToList())
        ...
        public static void Save(string[] arrSubDomainId)
        {
            ...
            {
                UserInSubDomain sdil = new UserInSubDomain();
                sdil.SubDomainId = item.Id;
                sdil.UserId = Args.User.Id;
                sdil.RemoveDB();
            }
            // add list
