...
namespace PSCPortal.Portlets.CarouselSlider
{
    public partial class Display : Engine.PortletControl
    {
        ...
        public string ListArticle
        {
            get
            {
                ...
                resultDic["resultList"] = ListArgs;
                resultDic["TopicId"] = Topic.Id;
                resultDic["TopicName"] = Topic.Name;
                results = serialize.Serialize(resultDic);
