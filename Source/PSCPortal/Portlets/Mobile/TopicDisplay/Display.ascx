...
<article class="mobileDisplay">
    <h1 class="tintuc_m">
        <img src="/Resources/ImagesPortal/HomePage/Mobile/i_tintuc.png"><a href="/?TopicId=<%#TopicId %>"><%#TopicName %></a></h1>
    <div class="new_m">
        <img src="<%# "/Services/GetArticleImage.ashx?Id=" + ArticleId %>">
        <a href="/?ArticleId=<%#ArticleId %>">
            <%#ArticleName%><%--<%#(DateTime.Now.Date - (DateTime)ArticleCreatedDate).Days <=3?"<img src='/Resources/ImagePhoto/new.gif' style='width:20px;height:10px;float:inherit;margin-bottom:0px'></img>":"" %>--%>
        </a>
    </div>
    <ul>
