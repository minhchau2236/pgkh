    ...
    public partial class Display : Engine.PortletControl
    {
        ...
        private void LoadTabControl()
        {
            ...
            for (int i = 0; i < listDisplayTopic.Count; i++)
            {
                ...
                const string userControlName = "Portlets/TabTopicDisplay/Lib/DisplayArticleTopic.ascx";
                Lib.DisplayArticleTopic userControl = (Lib.DisplayArticleTopic)Page.LoadControl(userControlName);
