<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display_TrungTam.ascx.cs" Inherits="PSCPortal.Portlets.ImageAutoRotator.Display_TrungTam" %>
                        ...
                        <div>
                            <ul data-bind="foreach: $data">
                                <li><a data-bind="attr: {href: Link}" target="_blank">
                                    <img data-bind="attr: {src: '/'+Url}" width="172" height="79" /></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
