...
{
    public partial class HotNewsSlider : Engine.PortletControl
    {
        ...
        public string ArticleImage
        {
            get
            {
                if (ViewState["ArticleImage"] == null)
                    ViewState["ArticleImage"] = string.Empty;
                return (string)ViewState["ArticleImage"];
            }
            set
            {
                ViewState["ArticleImage"] = value;
            }
        }
