<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="PSCPortal.Portlets.ImageViewer.Edit" %>
<div>
     <table>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <asp:GridView ID="gvImage" runat="server" AutoGenerateColumns="False" 
                ...
                onrowdeleting="gvImage_RowDeleting" Width="535px" OnRowEditing="gvImage_RowEditing" OnRowUpdating="gvImage_RowUpdating"
