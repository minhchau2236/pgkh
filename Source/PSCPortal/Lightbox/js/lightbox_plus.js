...
Lightbox.prototype = {
	refresh : function(target)
	{
		...
		this._imgs.length = 0;
		this._genListFromtopicLinks(target);
	},
	_init : function(option)
	{
		...
		if ( !option.skipInit ) self._genListFromtopicLinks(d);
		return self;
	},
	_genListFromtopicLinks : function(d)
	{
		var self = this;
		var topicLinks = d.getElementsByTagName("a");
		for (var i=0;i<topicLinks.length;i++)
		{
			var anchor = topicLinks[i];
